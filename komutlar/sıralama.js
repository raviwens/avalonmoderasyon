...
exports.run = async (client, msg, args) => {
    msg.delete();
  const yasak = client.emojis.get('702265610092150885');
  if (msg.channel.id !== '702259439012675689') return msg.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.**`).then(m => m.delete(5000));
